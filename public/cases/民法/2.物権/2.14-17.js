export default {
  ...
  story: [
    ...
    { type: 'dialogue', speaker: 'ナスオ', expression: 'passionate', dialogue: 'これは由々しき事態だぞ、ユズピ！君の所有権はどうなるんだ！？' },{ type: 'dialogue', speaker: 'ユズヒコ', expression: 'thinking', dialogue: '問題は、出品者Xが俺に「契約を解除する」と言ってきたことなんだ。この解除と、第三者である石田との関係がどうなるのか…。' },
    ...
    { type: 'dialogue', speaker: 'ナスオ', expression: 'excited', dialogue: '出た！解除と第三者の論点！つまり、石田がその「第三者」にあたるかってことだな！' },B --> C{石田がスニーカーの<br/>引渡しを受ける}
