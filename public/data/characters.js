...
export const characters = [
  ...
  // =============================================
  {
    ...
    baseName: 'yuzuhiko',
    age: '14歳（中学2年生）',
    persona: 'タチバナ家の長男。友人からは「ユズピ」と呼ばれる。家族や友達に対してはもちろんため口で話す。シャイで繊細な性格で、家族の中では最も常識人。母や姉の無神経な言動にいつも振り回されている苦労人。クラスの女子にモテるが本人は無自覚。アイドルの丸野丸美の隠れファン。法律知識が豊富で、姉に的確なアドバイスをする。【呼び方】みかんを「姉ちゃん」と呼ぶ。【場所】主にタチバナ家、ユズヒコの中学校に登場。',
